...
public class UserBookingPage extends javax.swing.JFrame {

    static User.customer user; 
    public UserBookingPage(User.customer user) {
        UserBookingPage.user = user;
        initComponents();
        ...
        backButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                pageSwitch.switchPage(UserBookingPage.this, new CustomerDashboard(user));
            }
        }); 

        ImageIcon imageIcon3 = new ImageIcon(getClass().getResource("/carrentalsystem/img/bookingConfirmation.png"));
        Image scaledImage3 = imageIcon3.getImage().getScaledInstance(210, 210, Image.SCALE_SMOOTH);
        BookingConfirmationButton.setIcon(new ImageIcon(scaledImage3));

        BookingConfirmationButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                pageSwitch.switchPage(UserBookingPage.this, new BookingConfirmation(user));
            }
        });

        ImageIcon imageIcon4 = new ImageIcon(getClass().getResource("/carrentalsystem/img/viewBookings.png"));
        Image scaledImage4 = imageIcon4.getImage().getScaledInstance(210, 210, Image.SCALE_SMOOTH);
        ViewBookingButtons.setIcon(new ImageIcon(scaledImage4));

        ViewBookingButtons.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                pageSwitch.switchPage(UserBookingPage.this, new CheckBooking(user));
            }
        });
    }
    ...
    private void initComponents() {
        ...
        ViewBookingButtons = new javax.swing.JLabel();
        jLabel2 = new javax.swing.JLabel();
        BookingConfirmationButton = new javax.swing.JLabel();
        ...
        ViewBookingButtons.setText("");
        ViewBookingButtons.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

        jLabel2.setFont(new java.awt.Font("Bahnschrift", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("View Bookings");

        BookingConfirmationButton.setText("");
        BookingConfirmationButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

        jLabel5.setFont(new java.awt.Font("Bahnschrift", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Booking Confirmation");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(207, 207, 207)
                        .addComponent(BookingConfirmationButton, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(222, 222, 222)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(195, 195, 195)
                        .addComponent(ViewBookingButtons, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    //         java.util.logging.Logger.getLogger(UserBookingPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    //         public void run() {
    //             new UserBookingPage(user).setVisible(true);
    //         }
    //     });
    // }
    ...
    private javax.swing.JLabel BookingConfirmationButton;
    ...
    private javax.swing.JLabel ViewBookingButtons;
